...
public final class WorldPermissionTable
{
    ...
    private WorldPermissionTable(Map<String, PermissionTable> worldPermissions)
    {
    ...
    )
    {
        ...
        return new WorldPermissionTable(Maps.newHashMap());
    }
    ...
    public void setStatus(Permission perm, PermissionStatus status, String world)
    {
